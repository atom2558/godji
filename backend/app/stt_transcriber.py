...
try:
    ...
    print(f"⚠️ [STT] Faster-Whisper init: {e}")
        ...
        try:
            ...
            if whisper_model:
                try:
                    ...
                    if text:
                        print(f"🎙️ [Faster-Whisper STT] Transcribed: '{text}'")
                        return text
                except Exception as we:
                    print(f"⚠️ [Faster-Whisper STT Error]: {we}")
            ...
            print(f"🎙️ [Google STT] Transcribed: '{text}'")
            return text

        except sr.UnknownValueError:
            print("🎙️ [STT] Speech Recognition: Silent or quiet audio")
            return ""
        except Exception as e:
